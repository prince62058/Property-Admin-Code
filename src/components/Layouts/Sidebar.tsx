...
import IconBuilding from '../Icon/IconArchive';
...
const Sidebar = () => {
    ...
    const getUserPermissions = () => {
        try {
            // Get permission from localStorage - it's stored as a string (array)
            const permissionData = localStorage.getItem('permission');
            if (permissionData) {
                // Parse the permission string to array
                // It might be stored as JSON string or comma-separated string
                let permissions: string[] = [];
                try {
                    permissions = JSON.parse(permissionData);
                } catch {
                    // If not JSON, try splitting by comma
                    permissions = permissionData.split(',').map(p => p.trim().toLowerCase()).filter(p => p);
                }
            ...
            if (adminData) {
                // admin is stored as ID, not full object
                // If you need role, you might need to fetch it separately or store it differently
            }
        } catch (error) {
    ...
    const hasPermission = (permission: string) => {
        // If permission array contains "all", show everything
        if (userPermissions.includes('all')) {
            return true;
        }
        // Otherwise, check if the specific permission exists in the array (case-insensitive)
        const lowerPermission = permission.toLowerCase();
        return userPermissions.some(p => p.toLowerCase() === lowerPermission);
    };
                            ...
                            <li className="nav-item">
                                <ul>
                                        ...
                                        <li className="nav-item">
                                            <NavLink to="/properties" className="group">
                                                <div className="flex items-center">
                                                    ...
                                                    <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Properties</span>
                                                </div>
                                            </NavLink>
                                        </li>
                                    )}
                                    {hasPermission('partners') && (
                                        <li className="nav-item">
                                            <NavLink to="/partners" className="group">
                                                <div className="flex items-center">
                                                    <IconUser className="group-hover:!text-primary shrink-0" />
                                                    <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Partners</span>
                                                </div>
                                            </NavLink>
                                        </li>
                                    )}
                                    {hasPermission('top broker') && (
                                        <li className="nav-item">
                                            <NavLink to="/top-brokers" className="group">
                                                <div className="flex items-center">
                                                    <IconStar className="group-hover:!text-primary shrink-0" />
                                                    <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Top Broker</span>
                                                </div>
                                            </NavLink>
                                        </li>
                                    )}
                                    {hasPermission('sliders') && (
                                        <li className="nav-item">
                                            <NavLink to="/sliders" className="group">
                                                <div className="flex items-center">
                                                    <IconLayoutGrid className="group-hover:!text-primary shrink-0" />
                                                    <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Sliders</span>
                                                </div>
                                            </NavLink>
                                        </li>
                                    )}
                                    {hasPermission('packages') && (
                                        <li className="nav-item">
                                            <NavLink to="/packages" className="group">
                                                <div className="flex items-center">
                                                    <IconBox className="group-hover:!text-primary shrink-0" />
                                                    <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Packages</span>
                                                </div>
                                            </NavLink>
                                        </li>
                                    )}
                                        ...
                                        <li className="nav-item">
                                            <NavLink to="/categories" className="group">
                                                <div className="flex items-center">
                                                    ...
                                                    <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Categories</span>
                                                </div>
                                            </NavLink>
                                        </li>
                                    )}
                                    {hasPermission('requirements') && (
                                        <li className="nav-item">
                                            <NavLink to="/requirements" className="group">
                                                <div className="flex items-center">
                                                    <IconListCheck className="group-hover:!text-primary shrink-0" />
                                                    <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Requirements</span>
                                                </div>
                                            </NavLink>
                                        </li>
                                    )}
                                    {hasPermission('purchase history') && (
                                        <li className="nav-item">
                                            <NavLink to="/purchase-history" className="group">
                                                <div className="flex items-center">
                                                    <IconCreditCard className="group-hover:!text-primary shrink-0" />
                                                    <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Purchase History</span>
                                                </div>
                                            </NavLink>
                                        </li>
                                    )}
                                    {hasPermission('cities') && (
                                        <li className="nav-item">
                                            <NavLink to="/cities" className="group">
                                                <div className="flex items-center">
                                                    <IconMapPin className="group-hover:!text-primary shrink-0" />
                                                    <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Cities</span>
                                                </div>
                                            </NavLink>
                                        </li>
                                    )}
                                    {hasPermission('coupons') && (
                                        <li className="nav-item">
                                            <NavLink to="/coupons" className="group">
                                                <div className="flex items-center">
                                                    <IconTag className="group-hover:!text-primary shrink-0" />
                                                    <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Coupons</span>
                                                </div>
                                            </NavLink>
                                        </li>
                                    )}
                                        ...
                                        <li className="nav-item">
                                            <NavLink to="/subadmin" className="group">
                                                <div className="flex items-center">
                                                    ...
                                                    <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Subadmin</span>
                                                </div>
                                            </NavLink>
                                        </li>
                                    )}
                                    {(hasPermission('send_notification') || hasPermission('notifications')) && (
                                        <li className="nav-item">
                                            <NavLink to="/send-notification" className="group">
                                                <div className="flex items-center">
                                        ...
                                        <li className="nav-item">
                                            <NavLink to="/company" className="group">
                                                <div className="flex items-center">
                                                    ...
                                                    <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Company</span>
                                                </div>
                                            </NavLink>
                                        </li>
                                    )}

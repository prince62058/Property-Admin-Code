...
const LoginCover = () => {
    ...
    const submitForm = async (e: React.FormEvent) => {
        ...
        try {
            const response = await fetch(`${BASE_URL}/adminLoginRegister`, {
                method: 'POST',
                headers: {
            ...
            console.log("Admin data:", json.admin);

            if (!response.ok || !json?.success || !json?.token || !json?.admin?.id) {
            ...
            } else if (json.admin.username) {
                localStorage.setItem('userName', json.admin.username);
            } else if (json.admin.fullName) {
                localStorage.setItem('userName', json.admin.fullName);
            }
            ...
            <div className="relative flex min-h-screen items-center justify-center bg-[url(/assets/images/auth/map.png)] bg-cover bg-center bg-no-repeat px-6 py-10 dark:bg-[#060818] sm:px-16">
                ...
                <div className="relative flex w-full max-w-[1502px] flex-col justify-between overflow-hidden rounded-md bg-white/60 backdrop-blur-lg dark:bg-black/50 lg:min-h-[758px] lg:flex-row lg:gap-10 xl:gap-0">
                    ...
                    <div className="relative flex w-full flex-col items-center justify-center gap-6 px-4 pb-16 pt-6 sm:px-6 lg:max-w-[667px]">
                            ...
                            <form className="space-y-5 dark:text-white" onSubmit={submitForm}>
                                ...
                                <div>
                                    <label className="flex cursor-pointer items-center">
                                        <input type="checkbox" className="form-checkbox bg-white dark:bg-black" disabled={loading} />
                        ...
                        <p className="absolute bottom-6 w-full text-center dark:text-white">© {new Date().getFullYear()}.Property Call Center All Rights Reserved.</p>
                    </div>
                </div>
            </div>
        </div>
